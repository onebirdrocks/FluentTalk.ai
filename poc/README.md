...
# PoC
### STT
python stt_whisper.py media/bueller_life_moves_pretty_fast.wav
```
python stt_whisper.py media/bueller_life_moves_pretty_fast.wav
...
/Users/onebird/github/FluentTalk.ai/stt_deepgram.py:33: DeprecatedWarning: prerecorded is deprecated as of 3.4.0 and will be removed in 4.0.0. deepgram.listen.prerecorded is deprecated. Use deepgram.listen.rest instead.
